 ...
 * @author dosen
 */
public final class BPJSCekRiwayatSuratKontrol extends javax.swing.JDialog {
    ...
    String bulanFormatted = String.format("%02d",cal.get(Calendar.MONTH)+1);
    //private int mounth = cal.get(Calendar.MONTH)+01;
    private int year = cal.get(Calendar.YEAR);
        
    /** Creates new form DlgKamar
     * @param parent
     * @param modal */
    public BPJSCekRiwayatSuratKontrol(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        Object[] row={"No Surat Kontrol","Jenis Layanan","Poli Tujuan","Tgl Rencana Kontrol","Kode Dokter","Nama Dokter"};
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            BPJSCekRiwayatSuratKontrol dialog = new BPJSCekRiwayatSuratKontrol(new javax.swing.JFrame(), true);
    ...
    public void tampilKontrol(String nomorkartu) {
        ...
        try {
            ...
            headers.add("user_key", koneksiDB.USERKEYAPIBPJS());
            requestEntity = new HttpEntity(headers);
            URL = link+"/RencanaKontrol/ListRencanaKontrol/Bulan/"+bulanFormatted+"/Tahun/"+year+"/Nokartu/"+nomorkartu+"/filter/2";
            root = mapper.readTree(api.getRest().exchange(URL, HttpMethod.GET, requestEntity, String.class).getBody());
            nameNode = root.path("metaData");
            if (nameNode.path("code").asText().equals("200")) {
                ...
                if (response.isArray()) {
                    ...
                    for (JsonNode list : response) {                       
                        tabMode.addRow(new Object[]{
                           list.path("noSuratKontrol").asText(),list.path("jnsPelayanan").asText(),list.path("namaPoliTujuan").asText(),list.path("tglRencanaKontrol").asText(),list.path("kodeDokter").asText(),list.path("namaDokter").asText()
                        });
                    }
                }
            }
